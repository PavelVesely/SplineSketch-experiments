...
public class SplineSketchProgram {
    ...
    public static void main(String[] args) {
        if (args.length != 4) {
            System.out.println("Usage: java SplineSketchProgram <dataset_file> <query_file> <sketch_size> <output_file>");
            return;
        }
        ...
        try {
            ...
            SplineSketch splineSketch = new SplineSketch(sketch_size, "");
